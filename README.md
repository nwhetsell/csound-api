...
The easiest way to install Boost is probably through [Homebrew](http://brew.sh). To install Homebrew, follow the instructions as [http://brew.sh](http://brew.sh). Then, run `brew install boost` in a Terminal.
...
* <code>csound.SetMessageCallback(<i>Csound</i>, function(<i>attributes</i>, <i>message</i>))</code>
