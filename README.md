...
The easiest way to install Boost is probably through [Homebrew](http://brew.sh). To install Homebrew, follow the instructions as http://brew.sh. Then, run `brew install boost` in a Terminal.
